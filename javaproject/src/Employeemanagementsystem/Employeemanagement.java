	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			case 1:System.out.println("\nEnter the following details to ADD list:\n");
				System.out.println("Enter ID :123,234,345,456");
				id = sc.nextInt();
				System.out.println("Enter Name :pavan,sai,ram,ravi");
				name = sc.next();
				System.out.println("Enter Salary :20000,23000,34000,45000");
				salary = sc.nextFloat();
				System.out.println("Enter Contact No :1236548970,3214568791,3458762190,1029834765");
				contact_no = sc.nextLong();
				System.out.println("Enter Email-ID :sai23@gmail.com,ram3@gmail.com,sree43@gmail.com,mani43@gmail.com");
				email_id = sc.next();
			...
			case 3: System.out.println("\nEnter the Employee ID to EDIT the details");
					...
					for(Employee e: al)
					{
						...
						do{
							...
							switch(ch1)
							{
							case 1: System.out.println("\nEnter new Employee ID:123,234,345,456");
									e.id =sc.nextInt();
									System.out.println(e+"\n");
									break;
							
							case 2: System.out.println("Enter new Employee Name:pavan,sai,ram,ravi");
									e.name =sc.nextLine();
									System.out.println(e+"\n");
									break;
									
							case 3: System.out.println("Enter new Employee Salary:20000,23000,34000,45000");
									e.salary =sc.nextFloat();
									System.out.println(e+"\n");
									break;
									
							case 4: System.out.println("Enter new Employee Contact No :1236548970,3214568791,3458762190,1029834765");
									e.contact_no =sc.nextLong();
									System.out.println(e+"\n");
									break;
									
							case 5: System.out.println("Enter new Employee Email-ID :Enter Email-ID :sai23@gmail.com,ram3@gmail.com,sree43@gmail.com,mani43@gmail.com");
									e.email_id =sc.next();
									System.out.println(e+"\n");
									break;
